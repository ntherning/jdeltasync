 ...
 */
public class HU01DecompressorInputStream extends FilterInputStream {


    /**
     * The decompressor used for this stream.
     */
    protected HU01Decompressor decompressor;
     ...
     * were encountered while decompressing that stream.
     */
    boolean eof;
     ...
     */
    public HU01DecompressorInputStream(InputStream is) {
        this(is, new HU01Decompressor(), BUF_SIZE);
    }
     ...
     */
    public HU01DecompressorInputStream(InputStream is, HU01Decompressor decompressor) {
        this(is, decompressor, BUF_SIZE);
    }
     ...
     */
    public HU01DecompressorInputStream(InputStream is, HU01Decompressor decompressor, int bsize) {
        super(is);
        if (is == null || decompressor == null) {
     ...
     *
     * <p>This behavior is inconsistent with
     ...
     * an {@link IOException} when called.
     *
     * @throws IOException
